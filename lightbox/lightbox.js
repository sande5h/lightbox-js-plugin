...
function includePopup() {
  let html =
    '<div id="i-popup"><span class="close" onClick="closePopup()"><img id="n-pop"src="/lightbox/images/close.png" alt="" ;"></span><img id="left-arrow"src="/lightbox/images/left-arrow.png"alt="logo"><img id="right-arrow" src="/lightbox/images/right-arrow.png"alt="logo"><img id="main-pop-image" src="/images/1.jpg" alt="logo" ></div>';
